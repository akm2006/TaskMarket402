      ...
      <div className="mx-auto grid max-w-6xl gap-6 lg:grid-cols-[minmax(0,1fr)_360px]">
        <section>
          ...
          <p className="mt-3 max-w-2xl text-sm leading-6 text-zinc-400">
            Phase 1 uses a typed mock mission. The form shows the locked MVP inputs without connecting to wallet,
            payment, relayer, AI, or persistence services.
          </p>
        ...
        <aside className="rounded-lg border border-zinc-800 bg-zinc-900/70 p-5">
          ...
          <dl className="mt-5 space-y-4 text-sm">
            ...
            <div>
              ...
              <dd className="mt-1 text-zinc-100">x402 and 1Shot are visible as mock WorkGraph nodes only.</dd>
            </div>
            <div>
